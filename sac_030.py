...
def train_eval(
    root_dir,
    env_name='AntRandGoalEval-v1',
    eval_env_name='AntRandGoalEval-v1',
  ...
  with tf.compat.v2.summary.record_if(
    ...
    actor_checkpointer = common.Checkpointer(
        ckpt_dir=os.path.join(root_dir, 'teacher_actor'),
        actor_net=actor_net,
    ...
    # saver = policy_saver.PolicySaver(eval_policy, 1)
    ...
    for _ in range(num_iterations):
      ...
      if global_step_val % video_interval == 0:
        ...
        # video_filename = FLAGS.root_dir + '/videos/sac' + env_name[:-3] + str(int(global_step_val)) + '.mp4'
        # test_saved_policy = tf.compat.v2.saved_model.load(FLAGS.root_dir + '/eval_policy/policy_3001k')
      ...
      if global_step_val % policy_checkpoint_interval == 0:
        ...
        # saver.save(FLAGS.root_dir + "/eval_policy/policy_" + str(int(global_step_val/1000)) + "k")
